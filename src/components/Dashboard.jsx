    ...
    <div className="parentblock">
        ...
        <div className="space">
          <div className="additem">
            <div style={{ paddingTop: "5px", paddingLeft: "10px" }}>
              ...
              >
                <path
                  d="M6.70825 11.5002H11.4999M11.4999 11.5002H16.2916M11.4999 11.5002V6.7085M11.4999 11.5002V16.2918"
                  stroke="white"
                  stroke-width="2"
            ...
            <div className="textbtn">Add New Document</div>
          </div>
        </div>
      ...
      <div className="block4">
        {/* <div className="pagination">
          <a href="#" style={{ backgroundColor: "#C5CDD4" }}>
            {" "}
            &#706;
          </a>
          <a href="#">1</a>
        ...
        {/* <div className="pageindex">100 &nbsp; &#8964;</div> */}
      </div>
    </div>
  );
}
